# LaTeX author support for the International Press journal *Geometry, Imaging and Computing* (*GIC*)
...
[Geometry, Imaging and Computing (GIC)](http://www.intlpress.com/GIC/) articles.
...
For the GIC journal `gic` option must be set
...
[github](https://github.com/vtex-soft/texsupport.intlpress-gic/issues) page.